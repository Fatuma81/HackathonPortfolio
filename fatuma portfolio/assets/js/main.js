...
$(document).ready(function($) {
  ...
  $.Scrollax();
	...
	var burgerMenu = function() {
		...
		$('.js-faim-nav-toggle').on('click', function(event) {
			event.preventDefault();
			var $this = $(this);
			if( $('body').hasClass('menu-show') ) {
				$('body').removeClass('menu-show');
				$('#faim-main-nav > .js-faim-nav-toggle').removeClass('show');
			} else {
				$('body').addClass('menu-show');
				setTimeout(function(){
					$('#faim-main-nav > .js-faim-nav-toggle').addClass('show');
				}, 900);
			}
		})
	};
...
// Highlight active section in nav with debounce
let scrollTimeout;
